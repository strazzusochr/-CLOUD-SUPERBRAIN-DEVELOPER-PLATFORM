...
4. Treat `.phase1-artifacts/hosted-browser-proof-20260504-235540.md` as historical provenance only. Current frontend evidence is the fresh Google Chrome report under `.codex/runs/CURRENT/master-goal/frontend/hosted-22x2-e1a3ec1f-chrome`; the unavailable Codex in-app Chrome bridge is not claimed.
