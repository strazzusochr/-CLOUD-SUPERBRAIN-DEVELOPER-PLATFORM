...
- Immutable staging selector is now `2d6d8ac7b7b74e3d8a5493fe52aa05ae98094569`; all six service images were published for `linux/arm64` and Hetzner staging was redeployed with `-UseImageFilesystem`.
...
- The verifier checks `active_gate_count=10`, `phase5_suite_plan_status=passed`, `production_rollout_claimed=false`, hosted progress `80%`, Phase 5 now `79%`, and immutable selector `2d6d8ac7b7b74e3d8a5493fe52aa05ae98094569`.
...
- Hosted proof passed after GHCR build/push plus Hetzner immutable deploy for `IMAGE_TAG=2d6d8ac7b7b74e3d8a5493fe52aa05ae98094569`: Active Memory Operations Bundle, Active Gateway Execution Bundle, Security Review Queue Export, browser-contract, and hosted-staging.
