...
- **T5 Phase 5:** RC4 bleibt historisch lokal verifiziert, deckt die neue Auth-/Dependency-Source aber nicht ab. Nach selektivem Commit/Push RC5 aus dem neuen Commit bauen und requalifizieren; P5 bleibt ehrlich `68%`. GHCR-Push und Release-Promotion bleiben Owner-Gates.
