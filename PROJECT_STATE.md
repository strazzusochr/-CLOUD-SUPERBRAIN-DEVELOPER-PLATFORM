...
- **T5 Phase 5:** DONE fuer die autonome RC11-Readiness: `17/19` Items sind kandidatengebunden verifiziert, P5 `68% -> 89%`. Nur Hosted-Candidate-Paritaet und Production OAuth bleiben Nullcredit/Owner-blockiert; GHCR-Publikation bleibt Post-Market.
