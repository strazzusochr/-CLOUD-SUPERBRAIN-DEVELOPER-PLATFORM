...
export default async function SevenLayerBar({ title = "Über 7 Cloud-Schichten verifiziert" }: { title?: string }) {
    ...
    <section className="layerbar" aria-label={title}>
      <div className="layerbar-head">
        ...
        {live ? (
          ...
          <Badge tone="amber">Spezifikation · /api/v1/clouds/layers bei Erreichbarkeit</Badge>
        )}
      </div>
