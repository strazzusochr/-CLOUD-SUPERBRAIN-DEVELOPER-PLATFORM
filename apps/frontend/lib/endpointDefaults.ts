...
const DEFAULTS: Record<string, () => Record<string, unknown>> = {
  ...
  "/api/v1/orchestrator/completion/contract": () => ({
    ...tag,
    ...
    required_success_roles: [...AGENT_ROLES],
    live_provider_calls: false,
    live_mcp_writes: false,
    production_deploy: false,
    provider_write: false,
    secret_output: false,
    non_claims: [
      "This projection exposes the deterministic contract; it does not replace executing its runtime verifier.",
      "No live provider call, live MCP write, provider write, deployment, release promotion, or secret output is performed.",
    ],
  }),
  "/api/v1/release-candidate/local/contract": () => ({
    ...tag,
    ...
    secret_output: false,
    non_claims: [
      "This is a local candidate contract projection, not a GHCR publication or hosted-staging proof.",
      "No production deployment, release promotion, live provider call, live MCP write, or secret output is performed.",
    ],
  }),
  ...
  "/api/v1/phase6/local-scoreboard-performance/contract": () => ({
    ...tag,
    ...
    evidence_ref: "phase6_local_scoreboard_performance_runtime_visible",
    ...
    non_claims: [
      "The projection does not claim hosted leaderboard sync, persistence, telemetry, or scale capacity.",
      "No network, provider, MCP, deployment, release-promotion, or secret-output action is performed.",
    ],
  }),
