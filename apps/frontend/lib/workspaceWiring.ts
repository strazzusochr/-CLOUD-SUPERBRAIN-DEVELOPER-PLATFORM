...
export const WORKSPACE_WIRING: WorkspaceSurfaceWiring[] = [
  ...
  },
  {
    ...
    hub: "workbench",
    primaryMode: "govern",
    dataSources: ["/api/v1/auth/contract", "/api/v1/auth/github", "/api/v1/auth/callback", "/api/v1/auth/me", "/api/v1/auth/refresh", "/api/v1/auth/logout", "/api/v1/audit/recent"],
  ...
  },
  {
    ...
    verifierRefs: [...commonVerifierRefs, "scripts/verify-retired-hosted-boundary.ps1", "scripts/verify-phase5-production-candidate-local.ps1"],
    eventKinds: ["verifying", "blocked"],
    live: false,
    writes: false,
    secretOutput: false,
  ...
  },
  {
    ...
    hub: "tools",
    primaryMode: "govern",
    dataSources: ["/api/v1/clouds/deployment-preflight", "/api/v1/auth/contract", "CLOSED_GATES", "/api/v1/auth/callback", "/api/v1/auth/me", "/api/v1/auth/logout", "/api/v1/auth/refresh"],
