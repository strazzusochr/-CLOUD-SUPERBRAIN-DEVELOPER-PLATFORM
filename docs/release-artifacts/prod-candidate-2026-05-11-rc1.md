...
hosted_selector_observed: `IMAGE_TAG=b9734ad55dc6488a56acca693b50ec9019bab01b`
hosted_selector_observed_at: `2026-05-15T04:49:25+02:00`
frontend_runtime_image_observed: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/frontend:b9734ad55dc6488a56acca693b50ec9019bab01b`
...
immutable_staging_parity_proof: `docs/release-artifacts/prod-candidate-2026-05-11-rc1-active-mcp-operations-immutable-staging-20260515.md`
...
- GHCR arm64 image build/push: `scripts\build-and-push.ps1 -Tag b9734ad55dc6488a56acca693b50ec9019bab01b -Builder superbrain_builder`; `docker buildx imagetools inspect` confirmed all six service tags for `linux/arm64`
- Immutable staging deploy: `scripts\deploy-to-staging.ps1 -UseImageFilesystem -ImageTag b9734ad55dc6488a56acca693b50ec9019bab01b -KeyPath <local-private-key>`
...
- Historical main deploy workflow for the previous immutable staging image commit: `https://github.com/strazzusochr/-CLOUD-SUPERBRAIN-DEVELOPER-PLATFORM/actions/runs/25833000061` (retained as prior evidence only; it is not claimed as the workflow for `b9734ad55dc6488a56acca693b50ec9019bab01b`)
...
- Immutable staging plan: `scripts\deploy-to-staging.ps1 -PlanOnly -UseImageFilesystem -ImageTag b9734ad55dc6488a56acca693b50ec9019bab01b`
- Immutable staging parity ready check: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha b9734ad55dc6488a56acca693b50ec9019bab01b`
- Immutable staging parity remote proof: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -RequireVerified -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha b9734ad55dc6488a56acca693b50ec9019bab01b -BaseUrl https://188-34-191-140.sslip.io -KeyPath <local-private-key>`
...
- The current release boundary source commit is `b9734ad55dc6488a56acca693b50ec9019bab01b`; the immutable image commit deployed to staging is `b9734ad55dc6488a56acca693b50ec9019bab01b`.
- This artifact does not claim a production rollout.
- Remote immutable Hetzner parity for `b9734ad55dc6488a56acca693b50ec9019bab01b` is current staging evidence only; production is still not rolled out.
