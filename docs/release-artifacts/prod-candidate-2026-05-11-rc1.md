...
scope: `release-boundary cleanup, HF router truth, frontend build, agent-api/runtime compile checks, hosted staging smoke checks, immutable staging image candidate, Phase 3 Security Audit Surface`
environment: `production-candidate`
source_branch: `chore/repo-bootstrap`
image_build_branch: `codex/live-agent-steering-ui-20260513`
source_commit_sha: `54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
source_commit_semantics: `Vercel production branch remains chore/repo-bootstrap; immutable GHCR images were built from codex/live-agent-steering-ui-20260513 at the current validated runtime head including live-agent UI/runtime state, Phase 5 runtime-selector truth, immutable image-filesystem staging proof, and the Phase 3 Security Audit Surface`
immutable_image_commit_sha: `54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
workflow_run_url: `https://github.com/strazzusochr/-CLOUD-SUPERBRAIN-DEVELOPER-PLATFORM/actions/runs/25833000061`
pipeline_status: `local Docker Buildx with arm64 binfmt built and pushed all six GHCR images for 54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf after py_compile, Next.js build, local Security Audit Surface verifier, and local browser-contract passed; hosted immutable deploy and hosted verifiers passed after push`
smoke_result: `passed`
...
immutable_tag_set: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/<service>:54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
owner_decision: `approved`
hosted_selector_observed: `IMAGE_TAG=54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
hosted_selector_observed_at: `2026-05-14T01:41:37Z`
frontend_runtime_image_observed: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/frontend:54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
...
immutable_staging_parity_proof: `docs/release-artifacts/prod-candidate-2026-05-11-rc1-security-audit-surface-immutable-staging-20260514.md`
...
- GHCR arm64 image build/push: `docker run --privileged --rm tonistiigi/binfmt --install arm64`, then `scripts\build-and-push.ps1 -Tag 54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf -Platforms linux/arm64 -Builder codex-multiarch`
- Immutable staging deploy: `scripts\deploy-to-staging.ps1 -UseImageFilesystem -ImageTag 54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf -KeyPath <local-private-key>`
...
- Immutable staging plan: `scripts\deploy-to-staging.ps1 -PlanOnly -UseImageFilesystem -ImageTag 54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
- Immutable staging parity ready check: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`
- Immutable staging parity remote proof: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -RequireVerified -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf -BaseUrl https://188-34-191-140.sslip.io -KeyPath <local-private-key>`
...
- The release boundary source commit is `54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`; the immutable image commit deployed to staging is `54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf`.
- This artifact does not claim a production rollout.
- Remote immutable Hetzner parity for `54bb064c8a5650f9a5c811179d3b4d0e1f38cfbf` is current staging evidence only; production is still not rolled out.
