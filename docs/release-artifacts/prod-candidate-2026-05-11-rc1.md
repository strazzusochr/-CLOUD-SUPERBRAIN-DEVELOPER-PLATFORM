...
immutable_tag_set: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/<service>:9d8469801b1dcdf8f8e4cd326be258389c0f8183`
owner_decision: `approved`
hosted_selector_observed: `IMAGE_TAG=9d8469801b1dcdf8f8e4cd326be258389c0f8183`
hosted_selector_observed_at: `2026-05-15T03:52:47+02:00`
frontend_runtime_image_observed: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/frontend:9d8469801b1dcdf8f8e4cd326be258389c0f8183`
...
immutable_staging_parity_proof: `docs/release-artifacts/prod-candidate-2026-05-11-rc1-active-agent-operations-immutable-staging-20260515.md`
...
- GHCR arm64 image build/push: `scripts\build-and-push.ps1 -Tag 9d8469801b1dcdf8f8e4cd326be258389c0f8183 -Builder superbrain_builder`; `docker buildx imagetools inspect` confirmed all six service tags for `linux/arm64`
- Immutable staging deploy: `scripts\deploy-to-staging.ps1 -UseImageFilesystem -ImageTag 9d8469801b1dcdf8f8e4cd326be258389c0f8183 -KeyPath <local-private-key>`
...
- Historical main deploy workflow for the previous immutable staging image commit: `https://github.com/strazzusochr/-CLOUD-SUPERBRAIN-DEVELOPER-PLATFORM/actions/runs/25833000061` (retained as prior evidence only; it is not claimed as the workflow for `9d8469801b1dcdf8f8e4cd326be258389c0f8183`)
...
- Immutable staging plan: `scripts\deploy-to-staging.ps1 -PlanOnly -UseImageFilesystem -ImageTag 9d8469801b1dcdf8f8e4cd326be258389c0f8183`
- Immutable staging parity ready check: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 9d8469801b1dcdf8f8e4cd326be258389c0f8183`
- Immutable staging parity remote proof: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -RequireVerified -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 9d8469801b1dcdf8f8e4cd326be258389c0f8183 -BaseUrl https://188-34-191-140.sslip.io -KeyPath <local-private-key>`
...
- The current release boundary source commit is `9d8469801b1dcdf8f8e4cd326be258389c0f8183`; the immutable image commit deployed to staging is `9d8469801b1dcdf8f8e4cd326be258389c0f8183`.
- This artifact does not claim a production rollout.
- Remote immutable Hetzner parity for `9d8469801b1dcdf8f8e4cd326be258389c0f8183` is current staging evidence only; production is still not rolled out.
