...
immutable_tag_set: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/<service>:6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`
owner_decision: `approved`
hosted_selector_observed: `IMAGE_TAG=6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`
hosted_selector_observed_at: `2026-05-15T10:34:00+02:00`
frontend_runtime_image_observed: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/frontend:6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`
...
immutable_staging_parity_proof: `docs/release-artifacts/prod-candidate-2026-05-11-rc1-active-frontend-orchestrator-immutable-staging-20260515.md`
...
- GHCR arm64 image build/push: `scripts\build-and-push.ps1 -Tag 6292a2f3c0cf0cfe02916f6fd0a6f940629adc52 -Builder superbrain_builder`; `docker buildx imagetools inspect` confirmed all six service tags for `linux/arm64`
- Immutable staging deploy: `scripts\deploy-to-staging.ps1 -UseImageFilesystem -ImageTag 6292a2f3c0cf0cfe02916f6fd0a6f940629adc52 -KeyPath <local-private-key>`
...
- Historical main deploy workflow for the previous immutable staging image commit: `https://github.com/strazzusochr/-CLOUD-SUPERBRAIN-DEVELOPER-PLATFORM/actions/runs/25833000061` (retained as prior evidence only; it is not claimed as the workflow for `6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`)
...
- Immutable staging plan: `scripts\deploy-to-staging.ps1 -PlanOnly -UseImageFilesystem -ImageTag 6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`
- Immutable staging parity ready check: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`
- Immutable staging parity remote proof: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -RequireVerified -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 6292a2f3c0cf0cfe02916f6fd0a6f940629adc52 -BaseUrl https://188-34-191-140.sslip.io -KeyPath <local-private-key>`
...
- The current release boundary source commit is `6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`; the immutable image commit deployed to staging is `6292a2f3c0cf0cfe02916f6fd0a6f940629adc52`.
- This artifact does not claim a production rollout.
- Remote immutable Hetzner parity for `6292a2f3c0cf0cfe02916f6fd0a6f940629adc52` is current staging evidence only; production is still not rolled out.
