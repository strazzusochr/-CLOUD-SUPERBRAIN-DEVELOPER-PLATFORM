...
scope: `release-boundary cleanup, HF router truth, frontend build, agent-api/runtime compile checks, hosted staging smoke checks, immutable staging image candidate, Phase 3 Security Audit Surface, Autonomous Team Dispatch UI, Security Review Queue, Security Review Queue Snapshot, Security Review Gate Summary`
environment: `production-candidate`
source_branch: `chore/repo-bootstrap`
image_build_branch: `codex/live-agent-steering-ui-20260513`
source_commit_sha: `9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
source_commit_semantics: `Vercel production branch remains chore/repo-bootstrap; immutable GHCR images were built from codex/live-agent-steering-ui-20260513 at the current validated runtime head including live-agent UI/runtime state, Phase 5 runtime-selector truth, immutable image-filesystem staging proof, the Phase 3 Security Audit Surface, Autonomous Team Dispatch UI, Security Review Queue, Security Review Queue Snapshot, and Security Review Gate Summary`
immutable_image_commit_sha: `9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
workflow_run_url: `https://github.com/strazzusochr/-CLOUD-SUPERBRAIN-DEVELOPER-PLATFORM/actions/runs/25833000061`
pipeline_status: `local Docker Buildx with arm64 binfmt built and pushed all six GHCR images for 9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad after py_compile, Next.js build, local Security Review Gate verifier, and local browser-contract passed; hosted immutable deploy plus hosted security-review-gate/browser/smoke verifiers passed after push`
smoke_result: `passed`
...
immutable_tag_set: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/<service>:9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
owner_decision: `approved`
hosted_selector_observed: `IMAGE_TAG=9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
hosted_selector_observed_at: `2026-05-14T04:40:01Z`
frontend_runtime_image_observed: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/frontend:9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
...
immutable_staging_parity_proof: `docs/release-artifacts/prod-candidate-2026-05-11-rc1-security-review-gate-immutable-staging-20260514.md`
...
- GHCR arm64 image build/push: `docker run --privileged --rm tonistiigi/binfmt --install arm64`, then `scripts\build-and-push.ps1 -Tag 9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad -Platforms linux/arm64 -Builder codex-multiarch`
- Immutable staging deploy: `scripts\deploy-to-staging.ps1 -UseImageFilesystem -ImageTag 9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad -KeyPath <local-private-key>`
...
- Immutable staging plan: `scripts\deploy-to-staging.ps1 -PlanOnly -UseImageFilesystem -ImageTag 9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
- Immutable staging parity ready check: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`
- Immutable staging parity remote proof: `scripts\manual\verify-phase5-staging-immutable-parity.ps1 -RequireVerified -ReleaseId prod-candidate-2026-05-11-rc1 -CandidateSha 9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad -BaseUrl https://188-34-191-140.sslip.io -KeyPath <local-private-key>`
...
- The release boundary source commit is `9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`; the immutable image commit deployed to staging is `9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad`.
- This artifact does not claim a production rollout.
- Remote immutable Hetzner parity for `9f1e52266b3d9f9ddbdfc226d68bd2379ead9fad` is current staging evidence only; production is still not rolled out.
