...
release_id: `prod-candidate-2026-07-20-local-rc2`
scope: `local content-addressed production-candidate requalification for six owned service images`
environment: `production-candidate`
source_branch: `claude/cloud-superbrain-analysis-127d2e`
source_commit_sha: `1d8304456a6a95a2a05de65cf0d576ee68c20733`
source_commit_semantics: `committed green runtime source with isolated browser/runtime candidate evidence and canonical external-gate classification; candidate images are built exclusively from git archive, excluding dirty and untracked worktree content`
immutable_image_commit_sha: `1d8304456a6a95a2a05de65cf0d576ee68c20733`
workflow_run_url: `unavailable-local-proof`
pipeline_status: `local candidate rebuild and full verifier verified; hosted stateful pipeline remains blocked`
smoke_result: `verified-local-chromium`
observability_check: `local-present-hosted-blocked`
rollback_note: `local rollback target is predecessor candidate c451fa8ff2b631685ad07ebcfcf4dc4a5b418e81; no hosted rollback is authorized or executed`
immutable_tag_set: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/<service>:1d8304456a6a95a2a05de65cf0d576ee68c20733`
...
- Focused commands: `npm run build:phase5-candidate-local`, `npm run verify:phase5-candidate-local`, and `npm run verify:current-release-candidate`.
