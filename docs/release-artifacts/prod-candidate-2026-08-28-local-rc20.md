...
release_id: `prod-candidate-2026-08-28-local-rc20`
scope: `real held-key browser interaction proof for requestAnimationFrame-polled generated games on top of RC19`
environment: `production-candidate`
source_branch: `codex/organism-visual-v2`
source_commit_sha: `c29c738b82e4e35cc1288bc603319cba60d167d2`
...
immutable_image_commit_sha: `c29c738b82e4e35cc1288bc603319cba60d167d2`
workflow_run_url: `https://github.com/strazzusochr/-CLOUD-SUPERBRAIN-DEVELOPER-PLATFORM/actions/runs/33200830176`
pipeline_status: `GitHub Actions pr-check run 33200830176 passed with binding_mode source_checkout_attestation_v1; checked_out_sha equals the candidate and the control delta is the single allowed path`
...
rollback_note: `local rollback target is RC19 source 5062de35a5c033354ba81a988d699aad418347c3; no hosted rollback is authorized or executed`
rollback_target_commit_sha: `5062de35a5c033354ba81a988d699aad418347c3`
immutable_tag_set: `ghcr.io/strazzusochr/cloud-superbrain-developer-platform/<service>:c29c738b82e4e35cc1288bc603319cba60d167d2`
immutable_tag_publish_status: `unpublished`
rollback_drill_proof: `docs/runbooks/rollback-deploy.md`
executed_rollback_rerun_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
owner_decision_proof: `docs/runtime-state/owner-input-manifest.json`
budget_review_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
open_questions_acceptance_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
risk_review_recheck_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
provenance_review_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
smoke_recheck_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
observability_recheck_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
browser_evidence_reactivation_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
browser_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
post_rollback_browser_revalidation_proof: `not-applicable-retired-rc1-boundary`
final_browser_e2e_recheck_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
full_verifier_sweep_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
truth_mirror_rebaseline_proof: `docs/runtime-state/phase5-credit-itemization.json`
release_readiness_rerun_proof: `docs/release-artifacts/prod-candidate-2026-08-28-local-rc20-readiness.json`
browser_rerun_status: `passed DEV-ONLY on 2026-08-28; browser contract, product acceptance with a real Cloudflare Workers AI generation and held-key input, 22-page actions, responsive 22-route proof, and O4 write proof are green against source c29c738b82e4e35cc1288bc603319cba60d167d2`
review_gate: `pending`
...
| ID | JA/NEIN | Beleg |
| --- | --- | --- |
| C1 | JA | Source-bound GitHub Actions run 33200830176 is recorded through the source-checkout attestation. |
