...
| 2026-04-23 | `docs/runtime-contracts/core-agent-profiles.md` | WP-04 Vertrag fuer vier Kern-Agentenprofile, Toolrechte und Output-Envelope dokumentiert | `verified` | vorbereitet, nicht implementiert, keine Agent-Container aktiviert |
| 2026-04-23 | `docs/runtime-contracts/memory-consolidation-job.md` | `git diff --check`; Secret-Pattern-Scan; Pflichtabschnitt-Scan | `verified` | vorbereitet, nicht implementiert, keine DB-, Embedding- oder Memory-Runtime-Aktivierung |
| 2026-04-23 | `docs/runtime-contracts/mcp-toolsets.md` | `git diff --check`; Secret-Pattern-Scan; Pflichtabschnitt-Scan | `verified` | vorbereitet, nicht implementiert, keine MCP-Server-, Browser-, E2B-, Docker- oder GitHub-Write-Aktivierung |
| 2026-04-23 | `docs/phase-2-readiness-matrix.md` | WP-01 bis WP-07 gegen Architektur-Layer, Proof-Ziele, Evidence Ledger, aktive Gates und Stop-Gates verdrahtet | `verified` | Runtime bleibt blockiert; keine Implementierungs-, Release-, Docker-, Secret-, DB- oder Main-Branch-Claims |
| 2026-04-23 | `docs/runtime-contracts/verification-harness.md` | `git diff --check`; Secret-Pattern-Scan; Pflichtabschnitt-Scan | `verified` | vorbereitet, nicht implementiert; keine Runtime-, Docker-, Secret-, Provider-, DB- oder Release-Claims |
| 2026-04-23 | `docs/memory/schema.md` | Pfad bei WP-05-Kontextpruefung nicht vorhanden | `needs-update` | Memory-Schema muss vor Runtime-Aktivierung wiederhergestellt oder per ADR ersetzt werden |
| 2026-04-23 | `docs/memory/schema.md` | `git diff --check`; Pflicht-Tabellen-Scan; Qdrant-Rollen-Scan; Secret-Pattern-Scan | `verified` | Schema-Vertrag wiederhergestellt; ersetzt den vorherigen `needs-update`-Hinweis nur fuer Dokumentation, keine DB-/Migration-/Runtime-Aktivierung |
