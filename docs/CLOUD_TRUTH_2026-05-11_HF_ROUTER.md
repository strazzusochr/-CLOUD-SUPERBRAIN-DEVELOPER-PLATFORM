...
- Release metadata/docs/verifier commits after `fc00a787b54399133a90158bb63f6228859b5c96` do not change app/runtime source scope when `release_metadata_only_delta=true`.
