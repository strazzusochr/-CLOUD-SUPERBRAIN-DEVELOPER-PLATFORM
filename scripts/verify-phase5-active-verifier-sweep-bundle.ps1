...
try {
  ...
  Assert-Contains "candidate verifier sweep proof" $candidate "active_verifier_sweep_bundle_proof: ``docs/release-artifacts/$ReleaseId-active-verifier-sweep-bundle-20260514.md``"
  ...
  $proofPath = "docs\release-artifacts\$ReleaseId-active-verifier-sweep-bundle-20260514.md"
