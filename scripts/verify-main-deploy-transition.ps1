...
foreach ($required in @(
  ...
  'pointer_matches_truth =',
  'successor publication predecessor release ID is invalid',
  'successor publication predecessor source SHA is invalid',
  'successor publication predecessor must differ from candidate',
  'successor candidate is not descended from the active release source',
  'successor publication predecessor registry evidence is not live-verified',
  'successor publication predecessor registry evidence is missing',
  'predecessor_evidence_requirements =',
  'registry_publish_performed',
  'successor publication predecessor registry evidence hash mismatch',
  'successor_artifact_path = pathlib.Path("docs/release-artifacts") / f"{truth[''release_id'']}.md"',
  'required_successor_metadata =',
  'immutable_tag_publish_status: `unpublished`',
  'owner_decision: `no-release`',
  'rollback_target_commit_sha:',
  'successor rollback target is not an ancestor of the active release source',
...
# rc27-source-prequalification-binding-15fb1ec6
