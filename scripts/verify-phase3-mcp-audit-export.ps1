...
$exportResponse = Invoke-WebRequest -Method GET -Uri "$BaseUrl/api/v1/audit/mcp/export?format=csv&limit=80&trace_id=$exportTraceId&request_id=$exportRequestId" -TimeoutSec 30
