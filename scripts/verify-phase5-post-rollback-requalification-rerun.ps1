...
$artifactPath = "docs\release-artifacts\prod-candidate-2026-05-05-rc1-post-rollback-requalification-rerun.md"
if (-not (Test-Path $artifactPath)) {
  throw "Missing post-rollback requalification rerun artifact: $artifactPath"
}
...
foreach ($required in @(
  ...
  Assert-Contains "post-rollback requalification rerun artifact" $artifact $required
}

$candidate = Get-Content "docs\release-artifacts\$ReleaseId.md" -Raw
Assert-Contains "candidate requalification rerun linked" $candidate "post_rollback_requalification_rerun_proof: ``docs/release-artifacts/prod-candidate-2026-05-05-rc1-post-rollback-requalification-rerun.md``"
...
Write-Host "[phase5-post-rollback-requalification-rerun] verified"
