...
try {
  ...
  Assert-Equal "master plan phase 2" ([int]$masterPlan.phase_percentages.phase_2) 89
  Assert-Equal "master plan phase 5" ([int]$masterPlan.phase_percentages.phase_5) 88
  Assert-Equal "master plan agent pool" ([int]$masterPlan.layer_percentages.layer_3) 76
