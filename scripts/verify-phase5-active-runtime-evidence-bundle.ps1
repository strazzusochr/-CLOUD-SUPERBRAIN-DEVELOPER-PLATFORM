...
try {
  ...
  Assert-Equal "master plan overall" ([int]$masterPlan.overall_percent) 82
  Assert-Equal "master plan phase2" ([int]$masterPlan.phase_percentages.phase_2) 89
  Assert-Equal "master plan phase5" ([int]$masterPlan.phase_percentages.phase_5) 88
