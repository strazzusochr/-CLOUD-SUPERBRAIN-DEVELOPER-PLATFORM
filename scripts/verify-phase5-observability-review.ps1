...
$artifactPath = "docs\release-artifacts\prod-candidate-2026-05-05-rc1-observability-review.md"
if (-not (Test-Path $artifactPath)) {
  throw "Missing observability review artifact: $artifactPath"
}
...
foreach ($required in @(
  ...
  Assert-Contains "observability review artifact" $artifact $required
}

$candidate = Get-Content "docs\release-artifacts\$ReleaseId.md" -Raw
Assert-Contains "candidate observability review linked" $candidate "Historical observability review reference: ``docs/release-artifacts/prod-candidate-2026-05-05-rc1-observability-review.md``"
...
Write-Host "[phase5-observability-review] verified"
